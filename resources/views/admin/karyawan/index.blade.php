            ...
            <div class="col-sm-12">
                ...
                <div class="card card-block">
                    ...
                    <div class="card-header">
                        <h3 class="card-title">
                            <a class="btn btn-primary btn-md" href={{ route('admin.karyawan.create') }}>
                            ...
                            <table id="dataSiswa" class="table table-striped table-bordered" style="width:100%; text-align: center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$karyawan->nisn}}</td>
                                        <td>{{$karyawan->name}}</td>
                                        <td>{{$karyawan->class}}</td>
                                        <td>{{$karyawan->gender}}</td>
                                        <td>{{$karyawan->pob}}</td>
                                        <td>{{$karyawan->dob}}</td>
                                        <td>{{$karyawan->religion}}</td>
                                        <td>{{$karyawan->name_parent}}</td>
                                        ...
                                        <td class="project-actions ">
                                            ...
                                            <a class="btn btn-danger btn-sm" href="javascript:void(0)" onclick="if(confirm('Are you sure you want to delete this student?')) $('#deleteForm-{{$karyawan->id}}').submit()">
